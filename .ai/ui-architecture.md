...
<Dialog open={open} onOpenChange={setOpen}>
  <DialogContent aria-describedby="dialog-description" aria-labelledby="dialog-title">
    <DialogTitle id="dialog-title">Usuń użytkownika</DialogTitle>
    <DialogDescription id="dialog-description">Czy na pewno chcesz usunąć tego użytkownika?</DialogDescription>
  </DialogContent>
</Dialog>
```
